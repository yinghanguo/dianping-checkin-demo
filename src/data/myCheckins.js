...
const IMG = {
  ...
  hotpot: "https://images.unsplash.com/photo-1585032226651-759b368d7246?w=600&q=80",
  ...
  alhambra_court: "https://images.unsplash.com/photo-1551038247-3d9af20df552?w=600&q=80",
  cathedral: "https://images.unsplash.com/photo-1559682468-a6a29e7d9517?w=600&q=80",
  ...
  plaza_espana: "https://images.unsplash.com/photo-1558370781-d6196949e317?w=600&q=80",
  ...
  trees: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=600&q=80",
};
...
export const MY_CHECKINS = [
  ...
  ck({ date:"9/29", weekday:"周一", time:"14:32",
    ...
    photos:["https://images.unsplash.com/photo-1569058242253-92a9c755a0ec?w=600&q=80"] }),
  ...
  ck({ date:"10/6", weekday:"中秋节", time:"06:30",
    ...
    photos:["https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=600&q=80"] }),
  ...
  ck({ date:"2/26", weekday:"周三", time:"07:25",
    ...
    photos:["https://images.unsplash.com/photo-1553621042-f6e147245754?w=600&q=80"] }),
  ck({ date:"2/25", weekday:"周二", time:"18:31",
    name:"Rusutsu Sakaba", city:"北海道", year:2025, district:"留寿都", category:"居酒屋",
    achievement:"我是2025年来自上海的第2位打卡者",
    photos:["https://images.unsplash.com/photo-1541167760496-1628856ab772?w=600&q=80"] }),
  ck({ date:"2/24", weekday:"周一", time:"18:05",
    ...
    photos:["https://images.unsplash.com/photo-1580822184713-fc5400e7fe10?w=600&q=80"] }),
  ...
  ck({ date:"4/29", weekday:"周六", time:"20:26",
    ...
    photos:["https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=80"] }),
  ck({ date:"4/29", weekday:"周六", time:"13:23",
    ...
    photos:["https://images.unsplash.com/photo-1503764654157-72d979d9af2f?w=600&q=80"] }),
